...
import numpy as np
try:
    from pynwb.core import DynamicTable, DynamicTableRegion, VectorIndex, VectorData, AlignedDynamicTable # pragma: no cover
except ImportError:                                                        # pragma: no cover
    from hdmf.common import DynamicTable, DynamicTableRegion, VectorIndex, VectorData, AlignedDynamicTable  # pragma: no cover
